...
const Blog = ({blog, handleAddToBookmark}) => {
    console.log(blog);
    const {title, cover, author_name, author_img, posted_date, reading_time, hashtags} = blog;
    return (
        <div className='mb-20'>
            ...
            <p>
                {
                    hashtags.map((hash, idx) => <span key={idx}><a href=""><span className='mx-2'>#{hash}</span></a></span>)
                }
            </p>
        </div>
    );
